 //SVG gauges script
var firstGauge = document.querySelector('.card-container:first-of-type .progress');
var firstTarget = parseInt(firstGauge.getAttribute('data-target'));
var firstGaugeReadout = document.querySelector('.card-container:first-of-type .percentage > .value');

// var secondGauge = document.querySelector('.card-container:nth-of-type(2) .progress');
// var secondTarget = parseInt(secondGauge.getAttribute('data-target'));
// var secondGaugeReadout = document.querySelector('.card-container:nth-of-type(2) .percentage > .value');


// var thirdGauge = document.querySelector('.card-container:nth-of-type(3) .progress');
// var thirdTarget = parseInt(thirdGauge.getAttribute('data-target'));
// var thirdGaugeReadout = document.querySelector('.card-container:nth-of-type(3) .percentage > .value');

// var fourthGauge = document.querySelector('.card-container:nth-of-type(4) .progress');
// var fourthTarget = parseInt(fourthGauge.getAttribute('data-target'));
// var fourthGaugeReadout = document.querySelector('.card-container:nth-of-type(4) .percentage > .value');

// var fifthGauge = document.querySelector('.card-container:nth-of-type(5) .progress');
// var fifthTarget = parseInt(fifthGauge.getAttribute('data-target'));
// var fifthGaugeReadout = document.querySelector('.card-container:nth-of-type(5) .percentage > .value');
